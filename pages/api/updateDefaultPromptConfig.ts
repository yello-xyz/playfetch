...
async function updateDefaultPromptConfig(req: NextApiRequest, res: NextApiResponse<PromptConfig>, user: User) {
...
export default withLoggedInUserRoute(updateDefaultPromptConfig)
