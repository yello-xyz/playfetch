...
const api = {
  ...
  updateInputValues: function (projectID: number, parentID: number, name: string, values: string[]) {
    return post(this.updateInputValues, { projectID, parentID, name, values })
  },
