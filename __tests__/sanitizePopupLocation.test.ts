...
testPopupLocation('Adjusts negative down', { right: 1000, bottom: 800 }, { right: 0, bottom: 0 })
...
testPopupLocation('Fixed width adjusts left', { top: 500, bottom: 800 }, { top: 300, bottom: 0 })
